...
describe("Calculator", () => {
  ...
  it("should show user input after clickling numbers and operations", () => {
    render(<Calculator />);
  ...
  it("should reuse the input after clicking equal sign and after click operation", () => {
  ...
  it("should renew the input after clicking equal sign and after click number", () => {
